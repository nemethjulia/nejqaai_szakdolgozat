...
public class MultipleVectorComponent extends JPanel {
	...
	public MultipleVectorComponent(List<MySparseVector> xVectors) {
		...
		for (int i = 0; i < xVectors.size(); i++) {
			VectorComponent comp = new VectorComponent(xVectors.get(i));
